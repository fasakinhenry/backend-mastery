# Backend Mastery - Iteration 1: Learning Phase

I will like to pick up learning backend development again. I learnt from the Mosh Hamedani's course on backend development using Node.js and Express.js a few years ago but I have not had the chance to practice it much since then. I have forgotten a lot of it which makes things worst and I need to relearn it from scratch :cry:
